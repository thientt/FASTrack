...
namespace FASTrack.Model.Concretes
{
    ...
    /// 
    /// </summary>
    public class HSTReasonRepository : IHSTReasonRepository
    {
        /// <summary>
        /// The _log service
        /// </summary>
        ...
        public DelayReasonDto Single(int id)
        {
            ...
            try
            {
                ...
                {
                    result = (from item in context.MST_Reason
        ...
        public async Task<DelayReasonDto> SingleAsync(int id)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    result = await (from item in context.MST_Reason
                                    where item.IsDeleted == false && item.Id == id
                                    select new DelayReasonDto()
                                    {
                                        Id = item.Id,
        ...
        public IEnumerable<DelayReasonDto> GetAll()
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = (from item in context.MST_Reason
        ...
        public async Task<IEnumerable<DelayReasonDto>> GetAllAsync()
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = await (from item in context.MST_Reason
                                     where item.IsDeleted == false
                                     select new DelayReasonDto()
                                     {
                                         Id = item.Id,
        ...
        public SaveResult Update(DelayReasonDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    var assembly = context.MST_Reason.Single(x => x.Id == entity.Id && x.IsDeleted == false);

                    assembly.Description = entity.Description;
                    assembly.LastUpdatedBy = entity.LastUpdatedBy;
                    assembly.LastUpdate = DateTime.Now;

                    context.Entry<MST_Reason>(assembly).State = System.Data.Entity.EntityState.Modified;
        ...
        public SaveResult Add(DelayReasonDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    MST_Reason add = context.MST_Reason.Create();
                    ...
                    context.Entry<MST_Reason>(add).State = System.Data.Entity.EntityState.Added;
                    result = context.SaveChanges() > 0 ? SaveResult.SUCCESS : SaveResult.FAILURE;
                }
            }
            catch (Exception ex)
        ...
        public SaveResult DeleteBy(int id)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    var assembly = context.MST_Reason.Single(x => x.Id == id && x.IsDeleted == false);
                    assembly.IsDeleted = true;
