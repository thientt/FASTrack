        ...
        public SaveResult Update(ReportTypesDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    ...
                    context.Entry<MST_ReportTypes>(assembly).State = System.Data.Entity.EntityState.Modified;
        ...
        public SaveResult Add(ReportTypesDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    ...
                    context.Entry<MST_ReportTypes>(add).State = System.Data.Entity.EntityState.Added;
                    result = context.SaveChanges() > 0 ? SaveResult.SUCCESS : SaveResult.FAILURE;
                }
            }
            catch (Exception ex)
