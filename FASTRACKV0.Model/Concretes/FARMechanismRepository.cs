...
namespace FASTrack.Model.Concretes
{
    ...
    /// 
    /// </summary>
    public class FARMechanismRepository : IFARMechanismRepository
    {
        /// <summary>
        /// The _log service
        /// </summary>
        ...
        public FARMechanismRepository(ILogService logService)
        {
        ...
        /// <param name="id">The identifier.</param>
        /// <returns></returns>
        public async Task<FARMechanismDto> SingleAsync(int id)
        {
            FARMechanismDto result = null;
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    result = await (from item in context.FAR_Mechanism
                                    where item.IsDeleted == false && item.Id == id
                                    select new FARMechanismDto()
                                    {
                                        Id = item.Id,
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<FARMechanismDto> GetAll()
        {
            IEnumerable<FARMechanismDto> results = null;
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = (from item in context.FAR_Mechanism
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<IEnumerable<FARMechanismDto>> GetAllAsync()
        {
            IEnumerable<FARMechanismDto> results = null;
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = await (from item in context.FAR_Mechanism
                                     where item.IsDeleted == false
                                     orderby item.Name
                                     select new FARMechanismDto()
                                     {
        ...
        /// <returns></returns>
        public SaveResult Update(FARMechanismDto entity)
        {
        ...
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        public async Task<SaveResult> UpdateAsync(FARMechanismDto entity)
        {
            SaveResult result = SaveResult.FAILURE;
        ...
        /// <param name="entities">The entities.</param>
        /// <returns></returns>
        public async Task<SaveResult> AddRangeAsync(IEnumerable<FARMechanismDto> entities)
        {
            SaveResult result = SaveResult.FAILURE;
            try
            {
        ...
        public SaveResult DeleteBy(int Id)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    var fabSite = context.FAR_Mechanism.Single(x => x.Id == Id && x.IsDeleted == false);
                    fabSite.IsDeleted = true;
                    fabSite.LastUpdate = DateTime.Now;
