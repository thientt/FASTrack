...
namespace FASTrack.Model.Concretes
{
    ...
    /// 
    /// </summary>
    public class MSTReasonINIRepository : IMSTReasonINIRepository
    {
        /// <summary>
        /// The _log service
        /// </summary>
        ...
        public MSTReasonINIRepository(ILogService logService)
        {
        ...
        public async Task<DelayReasonDto> SingleAsync(int id)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    result = await (from item in context.MST_ReasonINIReport
                                    where item.IsDeleted == false && item.Id == id
                                    select new DelayReasonDto()
                                    {
                                        Id = item.Id,
        ...
        public IEnumerable<DelayReasonDto> GetAll()
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = (from item in context.MST_ReasonINIReport
        ...
        public async Task<IEnumerable<DelayReasonDto>> GetAllAsync()
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = await (from item in context.MST_ReasonINIReport
                                     where item.IsDeleted == false
                                     select new DelayReasonDto()
                                     {
                                         Id = item.Id,
        ...
        public SaveResult Update(DelayReasonDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    ...
                    context.Entry<MST_ReasonINIReport>(assembly).State = EntityState.Modified;
        ...
        public SaveResult Add(DelayReasonDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    ...
                    context.Entry<MST_ReasonINIReport>(add).State = EntityState.Added;
                    result = context.SaveChanges() > 0 ? SaveResult.SUCCESS : SaveResult.FAILURE;
                }
            }
            catch (Exception ex)
        ...
        public SaveResult DeleteBy(int id)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    var assembly = context.MST_ReasonINIReport.Single(x => x.Id == id && x.IsDeleted == false);
                    assembly.IsDeleted = true;
