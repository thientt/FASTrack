...
namespace FASTrack.Model.Concretes
{
    ...
    /// 
    /// </summary>
    public class MSTServiceRepository : IMSTServiceRepository
    {
        /// <summary>
        /// The _log service
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MSTServiceRepository"/> class.
        /// </summary>
        /// <param name="logService">The log service.</param>
        public MSTServiceRepository(ILogService logService)
        {
        ...
        /// <returns></returns>
        public MSTServiceDto Single(int id)
        {
            ...
            try
            {
                ...
                {
                    result = (from item in context.MST_Services
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<MSTServiceDto> GetAll()
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = (from item in context.MST_Services
        ...
        public SaveResult Update(MSTServiceDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    ...
                    context.Entry<MST_Services>(service).State = EntityState.Modified;
        ...
        public SaveResult Add(MSTServiceDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    ...
                    context.Entry<MST_Services>(add).State = EntityState.Added;
                    result = context.SaveChanges() > 0 ? SaveResult.SUCCESS : SaveResult.FAILURE;
                }
            }
            catch (Exception ex)
        ...
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        public async Task<SaveResult> AddAsync(MSTServiceDto entity)
        {
            SaveResult result = SaveResult.FAILURE;
            try
            {
        ...
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        public SaveResult Delete(MSTServiceDto entity)
        {
            SaveResult result = SaveResult.FAILURE;
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    var assembly = context.MST_Services.Single(x => x.Id == entity.Id && x.IsDeleted == false);
                    assembly.IsDeleted = true;

                    context.Entry<MST_Services>(assembly).State = EntityState.Modified;
                    result = context.SaveChanges() > 0 ? SaveResult.SUCCESS : SaveResult.FAILURE;
                }
            }
            catch (Exception ex)
        ...
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        public async Task<SaveResult> DeleteAsync(MSTServiceDto entity)
        {
            SaveResult result = SaveResult.FAILURE;
