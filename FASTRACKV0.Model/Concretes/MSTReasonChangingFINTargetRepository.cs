...
namespace FASTrack.Model.Concretes
{
    ...
    /// 
    /// </summary>
    public class MSTReasonChangingFINTargetRepository : IMSTReasonChangingFINTargetRepository
    {
        /// <summary>
        /// The _log service
        /// </summary>
        ...
        public MSTReasonChangingFINTargetRepository(ILogService logService)
        {
        ...
        public DelayReasonDto Single(int id)
        {
            ...
            try
            {
                ...
                {
                    result = (from item in context.MST_ReasonChangingFINTarget
        ...
        public async Task<DelayReasonDto> SingleAsync(int id)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    result = await (from item in context.MST_ReasonChangingFINTarget
                                    where item.IsDeleted == false && item.Id == id
                                    select new DelayReasonDto()
                                    {
                                        Id = item.Id,
        ...
        public IEnumerable<DelayReasonDto> GetAll()
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = (from item in context.MST_ReasonChangingFINTarget
        ...
        public async Task<IEnumerable<DelayReasonDto>> GetAllAsync()
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = await (from item in context.MST_ReasonChangingFINTarget
                                     where item.IsDeleted == false
                                     select new DelayReasonDto()
                                     {
                                         Id = item.Id,
        ...
        public SaveResult Update(DelayReasonDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    var assembly = context.MST_ReasonChangingFINTarget.Single(x => x.Id == entity.Id && x.IsDeleted == false);

                    assembly.Description = entity.Description;
                    assembly.LastUpdatedBy = entity.LastUpdatedBy;
                    assembly.LastUpdate = DateTime.Now;

                    context.Entry<MST_ReasonChangingFINTarget>(assembly).State = System.Data.Entity.EntityState.Modified;
        ...
        public SaveResult Add(DelayReasonDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    MST_ReasonChangingFINTarget add = context.MST_ReasonChangingFINTarget.Create();
                    ...
                    context.Entry<MST_ReasonChangingFINTarget>(add).State = System.Data.Entity.EntityState.Added;
                    result = context.SaveChanges() > 0 ? SaveResult.SUCCESS : SaveResult.FAILURE;
                }
            }
            catch (Exception ex)
        ...
        public SaveResult DeleteBy(int id)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    var assembly = context.MST_ReasonChangingFINTarget.Single(x => x.Id == id && x.IsDeleted == false);
                    assembly.IsDeleted = true;
