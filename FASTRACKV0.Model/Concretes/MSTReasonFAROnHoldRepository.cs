...
namespace FASTrack.Model.Concretes
{
    ...
    /// 
    /// </summary>
    public class MSTReasonFAROnHoldRepository : IMSTReasonFAROnHoldRepository
    {
        /// <summary>
        /// The _log service
        /// </summary>
        ...
        public MSTReasonFAROnHoldRepository(ILogService logService)
        {
        ...
        public DelayReasonDto Single(int id)
        {
            ...
            try
            {
                ...
                {
                    result = (from item in context.MST_ReasonFAROnHold
        ...
        public async Task<DelayReasonDto> SingleAsync(int id)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    result = await (from item in context.MST_ReasonFAROnHold
                                    where item.IsDeleted == false && item.Id == id
                                    select new DelayReasonDto()
                                    {
                                        Id = item.Id,
        ...
        public IEnumerable<DelayReasonDto> GetAll()
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = (from item in context.MST_ReasonFAROnHold
        ...
        public async Task<IEnumerable<DelayReasonDto>> GetAllAsync()
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    results = await (from item in context.MST_ReasonFAROnHold
                                     where item.IsDeleted == false
                                     select new DelayReasonDto()
                                     {
                                         Id = item.Id,
        ...
        public SaveResult Update(DelayReasonDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    var assembly = context.MST_ReasonFAROnHold.Single(x => x.Id == entity.Id && x.IsDeleted == false);

                    assembly.Description = entity.Description;
                    assembly.LastUpdatedBy = entity.LastUpdatedBy;
                    assembly.LastUpdate = DateTime.Now;

                    context.Entry<MST_ReasonFAROnHold>(assembly).State = System.Data.Entity.EntityState.Modified;
        ...
        public SaveResult Add(DelayReasonDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    MST_ReasonFAROnHold add = context.MST_ReasonFAROnHold.Create();
                    ...
                    context.Entry<MST_ReasonFAROnHold>(add).State = System.Data.Entity.EntityState.Added;
                    result = context.SaveChanges() > 0 ? SaveResult.SUCCESS : SaveResult.FAILURE;
                }
            }
            catch (Exception ex)
        ...
        public SaveResult DeleteBy(int id)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    var assembly = context.MST_ReasonFAROnHold.Single(x => x.Id == id && x.IsDeleted == false);
                    assembly.IsDeleted = true;
