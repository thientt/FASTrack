        ...
        public SaveResult Update(MSTPackageTypesDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    ...
                    context.Entry<MST_PackageTypes>(assembly).State = System.Data.Entity.EntityState.Modified;
        ...
        public SaveResult Add(MSTPackageTypesDto entity)
        {
            ...
            try
            {
                using (FailureAnalysisEntities context = new FailureAnalysisEntities())
                {
                    ...
                    context.Entry<MST_PackageTypes>(add).State = System.Data.Entity.EntityState.Added;
                    result = context.SaveChanges() > 0 ? SaveResult.SUCCESS : SaveResult.FAILURE;
                }
            }
            catch (Exception ex)
