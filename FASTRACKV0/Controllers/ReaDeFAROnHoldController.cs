...
namespace FASTrack.Controllers
{
    ...
    public class ReaDeFAROnHoldController : AppController
    {
        /// <summary>
        ...
        public async Task<ActionResult> Details(int id)
        {
            ...
            var delayreason = await OnHoldRep.SingleAsync(id);
            if (delayreason == null)
                return HttpNotFound();
        ...
        public async Task<ActionResult> Create(DelayReasonViewModel delayreason)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await OnHoldRep.AddAsync(data);
        ...
        public async Task<ActionResult> Edit(int id, DelayReasonViewModel delayreason)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await OnHoldRep.UpdateAsync(data);
                if (result == Model.SaveResult.SUCCESS)
                    return RedirectToAction("Index");
            }
            return View(delayreason);
        ...
        /// <summary>
        /// Gets or sets the on hold rep.
        /// </summary>
        /// <value>
        /// The on hold rep.
        /// </value>
        [Inject]
        public IMSTReasonFAROnHoldRepository OnHoldRep { get; set; }
    }
}
